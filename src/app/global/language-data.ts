...
export const LANGUAGES: LanguageContent[] = [
  {
    ...
    audiences: [
      ...
      { name: "机构与企业", description: "为团队和员工提供统一培训，无论多少人参加，均按同一课时费率收费。" },
      { name: "政府与机构", description: "提供结构化的备考方案，并可根据采购和人力资源要求提供发票和进度报告。" },
    ],
    pricingTitle: "费用",
    pricingText: "统一费率：每 50 分钟课程 129 英镑。费用按课时计算，而非按人数——您可以单独上课，也可以带同事、朋友或家人一起参加，费用不变。购买 5、10 或 20 节课程套餐可享受优惠。",
    contactTitle: "联系方式",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "法人・団体", description: "チームやスタッフ向けの統一研修で、参加人数に関わらず同じセッション料金です。" },
      { name: "政府・公的機関", description: "調達や人事の要件に対応した、請求書発行や進捗報告を伴う体系的な指導プログラムです。" },
    ],
    pricingTitle: "料金",
    pricingText: "料金は一律です。50分セッションあたり129ポンドで、人数ではなくセッション単位の料金です。お一人でも、ご同僚やご家族と一緒でも料金は変わりません。5回・10回・20回のパッケージにはお得な割引があります。",
    contactTitle: "お問い合わせ",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "المؤسسات والشركات", description: "تدريب منسق للفرق والموظفين، بنفس سعر الجلسة مهما كان عدد المشاركين." },
    ...
    pricingText: "سعر ثابت واحد: 129 جنيهًا إسترلينيًا لكل جلسة مدتها 50 دقيقة. السعر لكل جلسة وليس لكل شخص — يمكنك الحضور بمفردك أو مع زملائك أو عائلتك بنفس السعر. تتوفر باقات مخفضة لـ 5 أو 10 أو 20 جلسة.",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "기업 및 단체", description: "팀과 직원을 위한 체계적인 교육으로, 참여 인원과 관계없이 동일한 세션 요금이 적용됩니다." },
      { name: "정부 및 기관", description: "조달 및 인사 요건에 맞춘 청구서 발행과 진행 보고가 가능한 체계적인 준비 과정입니다." },
    ],
    pricingTitle: "요금",
    pricingText: "단일 요금제: 50분 세션당 129파운드이며, 인원이 아닌 세션 단위로 요금이 부과됩니다. 혼자 참여하셔도, 동료나 가족과 함께 참여하셔도 요금은 같습니다. 5회, 10회, 20회 패키지 구매 시 할인이 적용됩니다.",
    contactTitle: "문의하기",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "Tổ chức & doanh nghiệp", description: "Đào tạo phối hợp cho nhóm và nhân viên, với cùng mức giá mỗi buổi dù có bao nhiêu người tham gia." },
    ...
    pricingText: "Một mức giá cố định: 129 bảng Anh cho mỗi buổi học 50 phút. Học phí tính theo buổi, không tính theo người — bạn có thể học một mình hoặc cùng đồng nghiệp, bạn bè hay gia đình với cùng mức giá. Có gói giảm giá cho 5, 10 hoặc 20 buổi học.",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "Organizaciones y empresas", description: "Formación coordinada para equipos y personal, con la misma tarifa por sesión, sea cual sea el número de participantes." },
    ...
    pricingText: "Una tarifa única: 129 libras esterlinas por sesión de 50 minutos. El precio es por sesión, no por persona: puede asistir solo o con compañeros, amigos o familiares por el mismo precio. Hay paquetes con descuento disponibles para 5, 10 o 20 sesiones.",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "Organisationen & Unternehmen", description: "Koordinierte Schulungen für Teams und Mitarbeitende, zum gleichen Sitzungspreis – unabhängig von der Teilnehmerzahl." },
    ...
    pricingTitle: "Preise",
    pricingText: "Ein einheitlicher Preis: 129 £ pro 50-minütiger Sitzung. Der Preis gilt pro Sitzung, nicht pro Person – Sie können allein teilnehmen oder Kollegen, Freunde oder Familie mitbringen, ohne Aufpreis. Vergünstigte Pakete sind für 5, 10 oder 20 Sitzungen erhältlich.",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "Organisations et entreprises", description: "Formation coordonnée pour les équipes et le personnel, au même tarif par séance, quel que soit le nombre de participants." },
    ...
    pricingTitle: "Tarifs",
    pricingText: "Un tarif unique : 129 £ par séance de 50 minutes. Le prix est par séance, pas par personne : vous pouvez venir seul ou avec des collègues, des amis ou votre famille, au même tarif. Des forfaits à prix réduit sont disponibles pour 5, 10 ou 20 séances.",
  ...
  },
  {
    ...
    audiences: [
      ...
      { name: "Organizações e empresas", description: "Formação coordenada para equipas e colaboradores, com a mesma tarifa por sessão, independentemente do número de participantes." },
    ...
    pricingTitle: "Preços",
    pricingText: "Uma tarifa única: 129 libras por sessão de 50 minutos. O preço é por sessão, não por pessoa: pode participar sozinho ou com colegas, amigos ou família pelo mesmo preço. Estão disponíveis pacotes com desconto para 5, 10 ou 20 sessões.",
    contactTitle: "Contacto",
