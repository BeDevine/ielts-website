...
export const LANGUAGES: LanguageContent[] = [
  {
    ...
    pricingTitle: "费用",
    pricingText: "统一费率：每 60 分钟课程 129 英镑，最多可容纳 10 人。购买 5、10 或 20 节课程套餐可享受优惠。",
    contactTitle: "联系方式",
  ...
  },
  {
    ...
    pricingTitle: "料金",
    pricingText: "料金は一律です。60分セッションあたり129ポンド、最大10名まで同料金でご利用いただけます。5回・10回・20回のパッケージにはお得な割引があります。",
    contactTitle: "お問い合わせ",
  ...
  },
  {
    ...
    pricingText: "سعر ثابت واحد: 129 جنيهًا إسترلينيًا لكل جلسة مدتها 60 دقيقة، لمجموعة تصل إلى 10 أشخاص معًا. تتوفر باقات مخفضة لـ 5 أو 10 أو 20 جلسة.",
  ...
  },
  {
    ...
    pricingTitle: "요금",
    pricingText: "단일 요금제: 60분 세션당 129파운드, 최대 10명까지 함께 참여 가능합니다. 5회, 10회, 20회 패키지 구매 시 할인이 적용됩니다.",
    contactTitle: "문의하기",
  ...
  },
  {
    ...
    pricingText: "Một mức giá cố định: 129 bảng Anh cho mỗi buổi học 60 phút, dành cho nhóm tối đa 10 người. Có gói giảm giá cho 5, 10 hoặc 20 buổi học.",
  ...
  },
  {
    ...
    pricingText: "Una tarifa única: 129 libras esterlinas por sesión de 60 minutos, para grupos de hasta 10 personas. Hay paquetes con descuento disponibles para 5, 10 o 20 sesiones.",
  ...
  },
  {
    ...
    pricingTitle: "Preise",
    pricingText: "Ein einheitlicher Preis: 129 £ pro 60-minütiger Sitzung, für bis zu 10 Personen gemeinsam. Vergünstigte Pakete sind für 5, 10 oder 20 Sitzungen erhältlich.",
  ...
  },
  {
    ...
    pricingTitle: "Tarifs",
    pricingText: "Un tarif unique : 129 £ par séance de 60 minutes, pour un groupe pouvant aller jusqu'à 10 personnes. Des forfaits à prix réduit sont disponibles pour 5, 10 ou 20 séances.",
  ...
  },
  {
    ...
    pricingTitle: "Preços",
    pricingText: "Uma tarifa única: 129 libras por sessão de 60 minutos, para um grupo de até 10 pessoas. Estão disponíveis pacotes com desconto para 5, 10 ou 20 sessões.",
    contactTitle: "Contacto",
